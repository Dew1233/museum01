package com.yegol.museum.generator;
...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/museum01?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    public static String username="root";
    public static String password="root";
    //父级别包名称
    public static String parentPackage = "com.yegol.museum";
    //代码生成的目标路径
    public static String generateTo = "/museum-generator/src/main/java";
    //mapper.xml的生成路径
    public static String mapperXmlPath = "/museum-generator/src/main/resources/mapper";
    ...
    //作者名
    public static String author = "com.yegol";
    //模块名称，用于组成包名
